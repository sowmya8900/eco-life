            ...
            for i in range(function_num):
                ...
                if concurrent_function==0:
                    ...
                    if i not in new_function:
                        ...
                        # new_function[i]= mopso.MOPSO(parameters,self.server_pair,function_name,self.ci_avg,self.carbon_intensity[j],invoke_interval[i][j-self.window_size])
                        ...
                        # new_function[i] = threadingPSO.threadingPSO(parameters,self.server_pair,function_name,self.ci_avg,self.carbon_intensity[j],invoke_interval[i][j-self.window_size])
                        new_function[i] = diffEq.diffEq(parameters,self.server_pair,function_name,self.ci_avg,self.carbon_intensity[j],invoke_interval[i][j-self.window_size])
